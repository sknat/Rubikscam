...
Concernant l'entrée par la camera, nous nous sommes fortement inspirés d'un exemple de la bibliothèque, que nous avons quasi entièrement réécrit. Il s'agit du programme de dialogue avec le CMOS, paramétrage de la caméra et formatage des données.
